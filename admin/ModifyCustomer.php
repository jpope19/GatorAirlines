...
<script type="text/javascript">
	document.getElementById("email").value="asd@asd.com";
	document.getElementById("first_name").value="asd";
	document.getElementById("last_name").value="asd";
	document.getElementById("password").value="asdasdasdasd";
	document.getElementById("addr").value="165a asd ";
	document.getElementById("city").value="Asd";
	document.getElementById("state").value="Florida";
	document.getElementById("zip").value="32608";
	document.getElementById("cc_num").value="1111111155555555";
	document.getElementById("u_type").value="0";
</script>