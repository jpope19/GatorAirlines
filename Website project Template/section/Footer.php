<!-- HTML for footer of all documents -->
<p class="legal"> &copy;2012 Gator Airlines. All Rights Reserved.
&nbsp;&nbsp;&bull;&nbsp;&nbsp;
Design by <a href= <!--"http://www.freecsstemplates.org"--> Gators on a Plane</a> </p>
