...
$_POST['e_depart_time'] = mktime(0,0,0,substr($_POST['depart'],0,2),substr($_POST['depart'],3,5),substr($_POST['depart']),6,9);
$_POST['e_return_time'] = mktime(0,0,0,substr($_POST['return'],0,2),substr($_POST['return'],3,5),substr($_POST['return']),6,9);
